...
# Choose background and text classes based on theme
...
# Apply theme to body via HTML wrapper (optional)
st.markdown(
    f'<div class="{bg_class} min-h-screen {text_class} p-4">',
...
if not st.session_state.authenticated:
    ...
    # Social login buttons (pure HTML with Tailwind)
    st.markdown(
        f"""
        <div class="flex flex-col gap-4 max-w-sm mx-auto">
            <a href="#" class="flex items-center justify-center gap-3 px-4 py-3 bg-white border border-slate-300 rounded-lg font-semibold text-slate-700 hover:bg-slate-100 transition">
            ...
            <a href="#" class="flex items-center justify-center gap-3 px-4 py-3 bg-slate-800 border border-slate-700 rounded-lg font-semibold text-white hover:bg-slate-700 transition">
