...
if not st.session_state.get("authenticated"):
        ...
        with st.form("signin_form"):
            ...
            if st.form_submit_button("Sign In", type="primary", use_container_width=True):
                if email and password and "@" in email:
                    ...
                    # For demo, assign role based on email or default to Admin
    ...
    st.stop()  # Do not show the rest of the page if not authenticated
...
# Existing connection forms (unchanged)
...
# ---------- New Live Cloud API Sync Section ----------
